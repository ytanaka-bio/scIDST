...
parser_train.add_argument('-r', help='learning rate', nargs=1, default=0.0001,type=float, dest="learning_rate")
parser_train.add_argument('-z', help='optimizer function', nargs=1, default="Adam",type=str,dest="opt_function")
